...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
   ...
   // loads jQuery 2.1.0
    ...
    // adding TabsletJS script file in the footer
    wp_enqueue_script( 'tabslet-js', get_template_directory_uri() . '/library/js/tabslet.js', array( 'jquery' ), '', true );

    wp_enqueue_style( 'googlefonts', 'http://fonts.googleapis.com/css?family=Oxygen|Open+Sans');
